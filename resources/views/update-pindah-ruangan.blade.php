              ...
              <div class="row">
                ...
                <div class="col-lg-12 col-md-12">
                  ...
                  <hr/>
                    ...
                    <h3>&nbsp;&nbsp;&nbsp;Form Pindah Ruangan Pasien</h3>. </p>
                  </div>
                
                </div>
                <div class="col-lg-12">
                  <form method="POST" action="/inhealth/update-pindah-ruangan-sjp-send/">
                      <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            Kelas Rawat
                            <input type="text" class="form-control" name="kelasrawat" autocomplete="off" required>
                          </div>
                        </div>
                        <div class="pull-right">
